...
# Modifications from slides code
import os
...
# Setup matplotlib to run headless.
...
def plot_training_cost(training_cost, num_epochs, training_cost_xmin):
    ...
    plt.savefig('plot_tester1_training_cost.png', format='png')
...
def plot_test_accuracy(test_accuracy, num_epochs, test_accuracy_xmin):
    ...
    plt.savefig('plot_tester2_accuracy.png', format='png')
...
def plot_test_cost(test_cost, num_epochs, test_cost_xmin):
    ...
    ax.grid(True)
    ax.set_xlabel('Epoch')
    plt.savefig('plot_tester3_cost_test_accuracy.png', format='png')
...
def plot_training_accuracy(training_accuracy, num_epochs, 
    ...
    plt.savefig('plot_tester4_training_accuracy.png', format='png')
...
def plot_overlay(test_accuracy, training_accuracy, num_epochs, xmin,
    ...
    plt.savefig('plot_tester5_plot_overlay.png', format='png')
